...
<head>
    ...
    <style>
        * { margin: 0; padding: 0; box-sizing: border-box; }
        ...
        .back-btn { display: block; width: 380px; margin: 10px auto 0; padding: 12px; background: #fff; color: #2d6a4f; border: 2px solid #2d6a4f; font-size: 14px; font-weight: 600; cursor: pointer; letter-spacing: 0.5px; text-align: center; text-decoration: none; }
...
<div>
    ...
    <a class="back-btn" href="{{ route('admin.orders.index') }}">Back to Orders</a>
</div>
